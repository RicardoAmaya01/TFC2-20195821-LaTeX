...
%%%%%%%%%%%%%%%
\input{style/frontmatter01_caratula}
...
%\input{style/ResumenDedicatoriaAgradecimiento}
%%%%%%% Índice
\tableofcontents
...
%%%%%%% Capítulos
\input{CHPTRS/CH01_INT/Antecedentes.tex}        \cleardoublepage
\input{CHPTRS/CH02_SA/Estado-del-arte.tex}      \cleardoublepage 
\input{CHPTRS/CH03_DICON/Diseno-Conceptual.tex} \cleardoublepage 
\input{CHPTRS/CH04_DISEÑO/DiseñoAsistente}       \clearpage
\input{CHPTRS/CH05_END/Conclusiones.tex}        \cleardoublepage 

%%%%%%% Bibliografía
% para citar ... \cite{}.
%\chapter{Bibliograf\'ia} % no needed, the option "title={Bibliograf\'ia" adds the chapter.}
\printbibliography[heading=bibintoc,title={Bibliograf\'ia}]
\ihead[]{Bibliograf\'ia}
\cleardoublepage
%\end{thebibliography}

%%%%%%% Anexos
\input{ANNEX/mainAnexos}
