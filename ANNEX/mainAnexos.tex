...
\input{ANNEX/Anexo_B_TablaVariables}
\cleardoublepage
%%%%%%%%% ANNEX C
...
\input{ANNEX/Anexo_D_precios_preliminares.tex}
\cleardoublepage


\chapter{Planos mecánicos}
\label{an:Annex_E_Planos_Mecánicos}
\input{ANNEX/Anexo_E_PlanosMecánicos.tex}
\chapter{Código de Programación del Sistema}
\label{an:Annex_F_CodigoSistema}
\input{ANNEX/Anexo_F_CodigoSistema.tex}
\chapter{Código de Programación de la Interfaz}
\label{an:Annex_G_CodigoSistema}
\input{ANNEX/Anexo_G_CodigoInterfaz.tex}
\cleardoublepage
%%%%%%%%% ANNEX C
