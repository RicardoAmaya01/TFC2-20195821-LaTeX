...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{CHPTRS/CH03_DICON/fig_cap3/Estructura de funciones tesis.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{CHPTRS/CH03_DICON/fig_cap3/Dominio software.pdf}
...
\label{sc:CH03-ev_tec-eco}
    ...
    \begin{itemize}
    \item  Puntaje $pX$, donde $X \in \mathbb{N} = \{0, 1, 2, 3, 4\}$ (Escala de Valores según VDI 2225) y se establece: 0 = No satisface, 1 = Apenas satisface, 2 = Suficiente, 3 = Bien, 4 = Excelente. 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{CHPTRS/CH03_DICON/fig_conceptos/Daigramas de Flujo TESIS.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{CHPTRS/CH03_DICON/fig_conceptos/Daigramas de Flujo Aplicativo.pdf}
