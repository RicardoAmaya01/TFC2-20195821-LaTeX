...
\section{Costos}
En esta sección se presentan los costos para el desarrollo del asistente. Asimismo, se debe recalcar que el diseño del asistente se baso en componentes disponibles localmente.
\subsection{Costo de diseño eléctrico}
En la tabla~\ref{tab:4.Costo componentes}, se muestra la estimación de los costos de los componentes electrónicos que se utilizan en el diseño electrónico del dispositivo.
...
\end{tabular}
\end{table}
\subsection{Costo de componentes y materiales para diseño mecánico}
...
\hline
Carcasa-Parte inferior-PETG & 1        & S/.34         \\ 
\hline
Carcasa-Parte superior-PETG & 1        & S/.18         \\ 
\hline
\multicolumn{2}{|c|}{Total}            & S/.52         \\
\hline
\end{tabular}
\end{table}
