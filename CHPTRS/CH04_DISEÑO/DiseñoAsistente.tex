...
\hline
\multirow{2}{*}{Características} & \multirow{2}{*}{Requisitos} & \multirow{2}{*}{Unidades} & \multicolumn{3}{c|}{Motor}         \\ 
\cline{4-6}
                                 &                             &                           & Tipo moneda & Móvil  & Cilíndrico  \\ 
\hhline{|===::===|}
Voltaje nominal                  & 3-5                         & V                         & 3           & 3      & 1.5-3       \\ 
\hline
Corriente nominal                & Mínima posible              & mA                        & 80          & 70     & 150         \\ 
\hline
Activación                       & PWM                         & -                         & PWM         & ~PWM   & PWM         \\ 
\hline
Dimensiones                      & Mínimas posibles            & mm                        & 10 Ø x 3    & 16 x 6 & 4 Ø x 11.5  \\ 
\hline
Peso                             & Mínimo posible              & g                         & 1g          & -      & 6g          \\
...
El transistor seleccionado es el 2N3904 que cuenta con una $V_{CE(sat)}$ de 0.3\,V, una ganancia $h_{FE}$ de 200 en promedio, un $V_{BE(sat)}$ de 0.95\,V máximo según su hoja de datos. Asimismo, como se sabe que la corriente del conector($I_C$) es 80\,mA por parte del motor y utilizando la relación $I_C=h_{FE}\,I_B$, con $h_{FE} = 200$ se obtiene que la corriente de la base ($I_{B}$) es igual a 0.4\,mA. Adicionalmente, conocienco  el voltaje que es emitido desde el microcontrolador es de 3.3\,V, se utiliza la Ecuación~\ref{ec:4.motor} para hallar el valor de la resistencia R1 que es de $5.875\,k\Omega$, eligiendo el valor comercial más próximo de $5.6\,k\Omega$.
\begin{align}
\label{ec:4.motor}
...
I_{B1}=\frac{V_{GPIO}-V_{BE(sat)}}{R1}\,\,\,\text{[\si{\ampere}]}
\end{align}

Finalmente, se ha colocado la resistencia $R2 = 47\,k\text{\si{\ohm}}$ de protección, para asegurar la llegada de solo $0.4\, \si{\milli\ampere}$ al transistor, la cual es una corriente muy por debajo de los 40\,mA permitidos por el GPIO del ESP32. Esta resistencia es colocada en paralelo a Base-Emisor, obtenido mediante la Ecuación~\ref{ec:4.motorR2}.
\begin{align}
\label{ec:4.motorR2}
...
Voltaje de entrada (Tipo C)                    & 5\,V                                      \\
Corriente de protección contra sobre corriente & 3\,A                                      \\
Corriente de carga ajustable                   & 1\,A                                      \\
Peso                                           & 2\,g                                      \\
...
\hline
Módulo ESP32 (BLE) & 100                  & 5          & 500           \\ 
\hline
Sensor MAX30101    & 20                   & 3.3        & 66            \\ 
\hline
Motor de vibración & 80                   & 3.3        & 264           \\ 
\hline
\multicolumn{3}{|c|}{Total}                            & 830 mW        \\
\hline
\end{tabular}
\end{table}
...
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Características del regulador  & Unidades & Requisitos   & MT3608      & U3V40F5             \\ 
\hhline{|=>{\arrayrulecolor{black}}=>{\arrayrulecolor{black}}=::==|}
Voltaje de Entrada             & V        & 3.7          & 2-24~       & 1.3-5               \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Voltaje de Salida              & V        & 5            & 5-28        & 5                   \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Corriente de salida            & mA       & Mín. 200     & 2           & 9.5                 \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Protección sobre - temperatura & -        & -            & SI          & -                   \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Eficiencia de conversión       & \%       & Mín. 90\%    & Máx. 93\%~  & Máx. 94 \%          \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Peso                           & g        & Mín. posible & 5           & 1.5                 \\ 
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
Dimensiones                    & mm       & Mín. posible & 36 x 17 x 7 & 15.4 x 15.4 x 5.59  \\
\cline{1-1}\arrayrulecolor{black}\cline{2-2}\arrayrulecolor{black}\cline{3-5}
\end{tabular}
\end{table}
...
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Características del regulador & Unidades & Requisitos   & MP1584      & AMS1117       \\ 
\hhline{~=>{\arrayrulecolor{black}}=>{\arrayrulecolor{black}}=::==|}
 & Voltaje de Entrada            & V        & 3.7          & 4.5 a 28V   & 4-12          \\ 
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Voltaje de Salida             & V        & 5            & 0.8 a 18    & 3.3           \\ 
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Corriente de salida           & mA       & min. 200     & 3000        & 800           \\ 
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Eficiencia de conversión      & \%       & Máx. posible & máx. 96\%   & 66 \%         \\ 
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Peso                          & g        & Mín. posible & 3           & 1.5           \\ 
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
 & Dimensiones                   & mm       & Mín. posible & 22 x 17 x 4 & 36 x 17 x 14  \\
\cline{2-2}\arrayrulecolor{black}\cline{3-3}\arrayrulecolor{black}\cline{4-6}
\end{tabular}
\end{table}
\begin{figure}[H]
...
De igual manera, en la Figura~\ref{fig:4.eficiencia33} se muestra la gráfica Eficiencia vs Corriente de salida del regulador \textit{Step-Down} seleccionado, donde si bien no se muestra la curva para una entrada de 5\,V. Por ello, a través de aproximaciones, permite tener una referencia aproximada de 85\%Además, la corriente de entrada de cada regulador se calcula en base la Ecuación~\ref{ec:4.regu}.
\begin{align}
\label{ec:4.regu}
I_{IN} &= \frac{I_{OUT}* V_{OUT}}{Eficiencia* V_{IN}} 
\end{align}

donde $I_{IN}$ e $I_{OUT}$  son las corrientes de entrada y salida del regulador, y $V_{IN}$ y $V_{OUT}$  son también los voltajes de entrada y salida del regulador. En el caso del regulador MP1584 se tiene como corriente de salida los 20\,mA del sensor en el primer caso, con un voltaje de salida 3.3V y un voltaje de entrada de 5\,V y una eficiencia de 85\%, dando como resultado que la corriente de entrada para este regulador $I_{INSD_1} =15.53\, mA$. Para el segundo caso, donde se consideran los 80 mA del motor, se obtiene$I_{INSD_2} =77.65\, mA$ A partir de esta, se obtiene la corriente de salida para el regulador \textit{Step-Up} a través de la Ecuación~\ref{ec:4.regu5}.
\begin{align}
\label{ec:4.regu5}
I_{outSU} &= I_{ESP}+ I_{INSD} 
\end{align}

donde $I_{ESP}$ es 100\,mA y $I_{INSD}$ corresponde a los 15.53\,mA y 77.65\,mA calculados previamente para caso, obteniendo una corriente de salida total de 115.53\,mA para el primer caso y 177.65\,mA para el segundo caso, reemplazando con los valores correspondientes para este regulador, se tiene que se necesita una corriente de entrada $I_{tot_1}=169.69\,mA$ para el primer caso y $I_{tot_2}=260.94\,mA$ para el segundo caso. A partir de este valor se puede seleccionar la batería adecuada para el asistente.
...
\begin{align}
\label{ec:4.cap}
Cap=I_{tot}*h\,\,\,[\si{\milli\ampere h}]
\end{align}

donde $I_{tot}$ corresponde a la corriente calculadas previamente para cada caso ($I_{tot_1}=169.69\,mA$ y $I_{tot_2}=260.94\,mA$ ) y $h$ son las horas requeridas del funcionamiento del sistema. Al reemplazar los valores mencionados se obtiene una capacidades de  678.76\,mAh y 1043.76\,mAh. Al observar estos resultados, es necesario optimizar el uso del motor unicamente en los casos de distracción con un tiempo de funcionamiento en el rango mencionado previamente.\\

Al implementar un factor de seguridad de 1.3 considerando que las baterías pueden descargarse hasta un 80\% para no dañarse, se requieren 877.65\,mAh y 1356.88\,mAh. Sin embargo, se optó por una batería de 1000\.mAh (ver Figura~\ref{fig:4.bateria}), ya que se busca que el motor este en funcionamiento por tiempos muy cortos de retroalimentación. Además, permite conseguir una duración de 5.92 horas aproximadamente en el primer caso, es comercial y tiene un tamaño compacto.
...
El switch que se ha decidido emplear en el presente trabajo es uno de tipo botón que cuenta con enganche (ver Figura~\ref{fig:4.boton}), ya que este permitirá con facilidad que el usuario pueda identificar cuando esta encendido y cuando apagado. Asimismo, cuenta con una alta disponibilidad adecuada y es compacto, lo cual facilita su integración. Además, soporta una corriente de 0.3\,A\,@\, 30\,V. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{CHPTRS/CH04_DISEÑO/imagenes/boton.png}
...
\subsection{Diagrama esquemático y PCB}
...
Además, en las Figuras~\ref{fig:4.PCBS} se aprecia el diseño PCB realizado por el autor para el asistente. En este se ubican ambos reguladores, el módulo de carga el circuito de protección del motor, así como los conectores para la batería, motor y sensor.
\begin{figure}[H]
    \centering
    % Primera imagen
    \begin{subfigure}{0.4\textwidth}
         \centering
            \includegraphics[width=0.9\textwidth]{CHPTRS/CH04_DISEÑO/imagenes/pcb.png}
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \centering
        \includegraphics[width=0.9\linewidth]{CHPTRS/CH04_DISEÑO/imagenes/pcb 3d.png}
...
Características            & Unidades & PETG & ABS  \\
Densidad                   & g/cm3    & 1.23 & 1.01 \\
Módulo de elasticidad      & Gpa      & 2.0  & 2.0  \\
Resistencia a tracción     & MPa      & 50   & 40   \\
Facilidad de impresión     & -        & Alta & Baja \\
Temperatura de deformación & °C       & 80   & 105  
\end{tblr}
\end{table}
...
Asimismo, tiene espacios donde se colocará el sensor MAX30102 y el motor de vibración que serán colocados por encaje a presión ( ver Figura~\ref{fig:4.modeladoBase2}). Asimismo, tiene una caja donde será colocada la barra de inserción de la parte superior, como se mencionó previamente, este es solo para prototipado, ya que ambas partes irán pegadas. 
\begin{figure}[H]
    \centering
...
Finalmente, con los latidos detectados se calcula el \ac{RR} y, a partir de este, la \ac{BPM}. Adicionalmente, se descartan valores fisiológicamente irregulares. Por ejemplo, no se toma en cuenta frecuencias mayores a 140 BPM. El diagrama de flujo para el procesamiento se encuentra en la Figura~\ref{fig:cod.sensor}.

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{CHPTRS/CH04_DISEÑO/imagenes/imag_cod/Diagrama procesamiento.pdf}
...
En esta sección se detallan las estimaciones de costos de fabricación de la carcasa y la correa. En la Tabla~\ref{tab:4.Costo carcasa} se muestra los costos de fabricación de la carcasa tanto de la parte inferior como de la parte superior. La cotización pertenece a La cotización pertenece a \href{https://3dprint.pe}{\textcolor{black}{3Dprint.pe}}.
...
\begin{tabular}{|c|c|c|c|c|} 
\hline
Componente                                                                           & Proveedor      & Precio Unitario (S/.) & Cant. & Precio Total(S/.)  \\ 
\hline
\begin{tabular}[c]{@{}c@{}}Inserto roscado para\\impresion 3D con perno\end{tabular} & A          & 0.5                & 4        & 2.0        \\ 
\hline
Correa de Nylon                                                                      & B & 24                  & 1        & 24         \\ 
\hline
Velcro adhesivo                                                                      & C  & 3.1                & 2        & 6.20       \\ 
\hline
\multicolumn{4}{|c|}{Costo Total}                                                                                                              & 32.20       \\
\hline
\end{tabular}
\caption*{\textit{Nota: Proveedor A = MTLab, B = Deming Taguchi, C = Coto Trapillo}}
\end{table}
...
\begin{figure}[H]
    ...
    \label{fig:impreso}
\end{figure}
\subsection{Validación de sujeción de correa}
Para poder validar la sujeción de la correa, se utilizó una báscula manual para maletas que se puede apreciar en la Figura~\ref{fig:sim.bscula}. Esta se colocó en una de las barras circulares como se puede apreciar en la Figura~\ref{fig:sim.basculacolocada}.\\

Los resultados son satisfactorios, ya que al momento de realizar la tensión manualmente se obtuvo un valor aproximado de 10 kg como se puede apreciar en la Figura~\ref{fig:sim.valor}, lo cual equivale a 98.1N. validando los resultados de los cálculos realizados previamente (ver Sección \ref{sec:sujecion}) para las barras circulares con una fuerza de 40N. 
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \hfill % Relleno para separarlas horizontalmente
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.65\linewidth]{CHPTRS/CH04_DISEÑO/imagenes/imag_sim/Báscula.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{CHPTRS/CH04_DISEÑO/imagenes/imag_sim/prueba sujecion.png}
        \caption{Tensión en carcasa}
        \label{fig:sim.tension}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{CHPTRS/CH04_DISEÑO/imagenes/imag_sim/valor sujecion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{CHPTRS/CH04_DISEÑO/imagenes/imag_sim/SensorBrazo.png}
...
Asimismo, en la prueba realizada se obtuvo un baseline estimado de 1.08, que corresponde al patrón noraml del usuario en reposo. En los primeros segundos, se observaron valores elevados de \ac{LF}/\ac{HF} de 1.43, asociados directamente a distracción. Esta fue disminuyendo hasta valores aproximados de 0.8, indicativo de concentración sostenida. Adicionalmente, se detectaron periodos con valores cercanos al baseline, lo cual indica concentración moderada. Estos resultados demuestran que es sistema es capaz de identficar de manera dinámica transiciones entre estados de concentración con la variabilidad de la frecuencia cardíaca. Sin embargo, durante la prueba también se presentaron periodos donde el usuario detecto distracción (ultimo momento en la Tabla~\ref{tab:4.pruebaSens}), pero el sistema clasificó como concentración, lo cual evidencia que se deben realizar ajustes al umbral dinámico realizado y una mayor cantidad de pruebas con distintos usuarios para poder identificar las causas de  estos errores del umbral y mejorar la robustez del sistema.

\begin{table}[H]
\centering
\caption{Momentos clave durante la prueba del usuario}
\label{tab:4.pruebaSens}
\begin{tblr}{
  row{odd} = {c},
  row{2} = {c},
  row{6} = {c},
...
Momento                        & LF    & HF    & LF/HF & Estado                 \\
Inicio posterior a calibración & 23.32 & 16.21 & 1.44  & Distracción            \\
Transición 1                    & 18.85 & 19.71 & 0.96  & Alta concentración     \\
Transición 2                    & 18.02 & 21.71 & 0.83  & Alta concentración     \\
Fase estable de concentración  & 12.67 & 25.94 & 0.44  & Alta concentración     \\
Transición 3                   & 19.37 & 19.06 & 1.02  & Concentración Moderada \\
Ultima fase de concentración   & 18.79 & 22.48 & 0.83  & Alta concentración     
\end{tblr}
\end{table}