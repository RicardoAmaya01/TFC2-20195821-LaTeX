    ...
    \label{sec:CH01_Objetivos}
        ...
        \begin{itemize}
           ...
           \item Realizar el diseño mecánico del asistente, incluyendo planos mecánicos, cálculos relevantes y modelado 3D del asistente.
            ...
            \item Validar la mejora de concentración a través de simulaciones realizadas a partir de los componentes seleccionados, validando su funcionamiento.
            \item Detallar los costos de los materiales del proyecto para garantizar un bajo costo en el desarrollo del asistente.
            \end{itemize}
%%%%%%%%%%%%%%%%%%%%%% OBJETIVOS TFC1            
