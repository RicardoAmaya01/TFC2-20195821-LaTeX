...
\begin{itemize}
    ...
    \item La lista de requerimientos definida responde a las necesidades funcionales del sistema y a las limitaciones prácticas de portabilidad y ergonomía. Por ello, esta lista ha guiado el desarrollo del asistente a lo largo del presente trabajo. 
    
    \item La descomposición del asistente mediante la estructura de funciones permitió identificar los dominios clave y la relación entre estos, asegurando el cumplimiento de los requerimientos del sistema definidos previamente.
    ...
    \item El desarrollo del circuito electrónico del sistema ha permitido identificar la capacidad para realizar dispositivos con componentes disponibles localmente que cumplan el funcionamiento deseado. Sin embargo, se identificaron limitaciones asociadas  al tamaño del hardware, ya que las dimensiones finales del asistente dependen directamente de los componentes electrónicos seleccionados.
    
    \item El desarrollo del diseño mecánico, elaborado mediante material PETG, permitió validar el diseño de la carcasa, así como su resistencia mediante pruebas en prototipo físico mediante impresión 3D. Asimismo, el diseño cumple con la exigencia de permitir un fácil montaje.
    
    \item El desarrollo del software del sistema ha permitido cumplir con la exigencia que corresponde a que el procesamiento básico se debe realizar localmente en el microcontrolador. Asimismo, se logró desarrollar un prototipo de interfaz móvil mediante Flutter, capaz de establecer la configuración del usuario y recibir datos del asistente mediante \ac{BLE}.
    ...
    \item  El costo de materiales demuestra que es posible desarrollar un asistente portátil, funcional y de bajo costo comparado con alternativas comerciales mencionadas en el Capítulo \ref{ch:CH02-Estado-del-Arte}.
\end{itemize}
