...
\acro{LF}{\textit{Low Frequency}}
\acro{HF}{\textit{High Frequency}}
\acro{SW}{Software}
\acro{RR}{Tiempo entre pulsos sucesivos}
\acro{BPM}{Frecuencia cardíaca instantánea}
\acro{FFT}{Transformada de Fourier}
