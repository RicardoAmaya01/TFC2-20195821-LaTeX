...
\lstdefinelanguage{Dart}{
  keywords={class, extends, return, new, void, import, final, const, async, await, override, true, false, null, if, else, for, while, var, dynamic, late, required, static, super},
  keywordstyle=\color{dartKeyword}\bfseries,
  ndkeywords={Widget, BuildContext, State, StatefulWidget, StatelessWidget, MaterialApp, Scaffold, AppBar, Text, Center, Column, ElevatedButton, Image, Navigator, Future, Stream, AsistenteApp, StartScreen},
  ndkeywordstyle=\color{dartClass}\bfseries,
  identifierstyle=\color{black},
  sensitive=true,
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  commentstyle=\color{dartComment}\ttfamily,
  stringstyle=\color{dartString}\ttfamily,
  morestring=[b]',
  morestring=[b]"
}